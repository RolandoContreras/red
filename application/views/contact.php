                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <label data-add-placeholder>
                                    <input type="text" id="name" name="name" placeholder="Nombre" data-constraints="@NotEmpty @LettersOnly"/>
                                </label>
                            </div>
                            <div class="col-sm-6">
                                <label data-add-placeholder>
                                    <input type="text"  id="email" name="email" placeholder="Email" data-constraints="@NotEmpty @Email"/>
                                </label>
                            </div>
                            <div class="col-xs-12">
                           ...
                           <div class="col-sm-6">
                            ...
                            <div class="col-xs-12 text-center">
                                    <div class="mfControls">
                                        <button onclick="send_messages();" class="btn btn-md btn-primary" type="button">Enviar</button>
                                    </div>
                            </div>
                        </div>
                    </fieldset>
