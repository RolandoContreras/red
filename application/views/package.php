	...
	<div id="page" class="single_page">
		...
		<section class="breadcrumbs_block clearfix parallax">
			<div class="container center">
				<h2><b>Paquete</b> <?php echo $title;?></h2>
			</div>
		</section><!-- //BREADCRUMBS -->
				...
				<div class="owl-demo owl-carousel projects_slider">
						...
						<div class="work_item">
							...
							<div class="work_description">
								<div class="work_descr_cont">
                                                                    <a href="<?php echo site_url().'paquete/basic';?>" >Paquete Basic</a>
					...
					<div class="item">
						<div class="work_item">
							...
							<div class="work_description">
								<div class="work_descr_cont">
									<a href="<?php echo site_url().'paquete/executive';?>">Paquete Executive</a>
									<span><?php echo replace_vocales_voculeshtml("Actívate Ahora");?></span>
								</div>
							</div>
						</div>
					...
					<div class="item">
						<div class="work_item">
							...
							<div class="work_description">
								<div class="work_descr_cont">
									<a href="<?php echo site_url().'paquete/master';?>" >Paquete Master</a>
                                                                    <span><?php echo replace_vocales_voculeshtml("Actívate Ahora");?></span>
								</div>
							</div>
						</div>
