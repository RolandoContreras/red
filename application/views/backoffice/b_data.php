...
<head>
   ...
   <meta name="keywords" content="millenium, software, multinivel, binario, forzada, matriz, unilevel">
	   ...
	   <!-- DATATABLES-->
   		...
   		<link rel="stylesheet" href="../app/vendor/datatable-bootstrap/css/dataTables.bootstrap.css">

	   <!-- =============== APP STYLES ===============-->
	   <link rel="stylesheet" href="../app/css/app.css" id="maincss">

	   <!-- =============== APP TEMAS ===============-->
	   <link id="autoloaded-stylesheet" rel="stylesheet" href="../app/css/theme-e.css">
...
<body>
   <div class="wrapper">
      ...
      <footer style="display: block !important;">
						<span>Software Millenium &copy; 2016</span>
      				</footer>   </div>
   ...
   <script type="text/javascript">
      function eliminar_direccion(id){
         swal({
            title: "Alerta!", 
            text:"¿Esta seguro de eliminar esta dirección?", 
            type: "warning",  
            ...
            function(isConfirm){ 
               if(isConfirm){  
                  ...
                  $.ajax({
                     ...
                     data: {"EliminarDireccionAfiliado":id},
      ...
      $(document).ready(function() {
         var id = '';         $('#example').DataTable({
            ajax: "../includes/ajax_table.php?tipo=2&id="+id,
            responsive: true
         });

         $("form[name=FormEditarAfiliados]").submit(function(){
            $.ajax({
               type: "POST",
               dataType: "json",
               url: "../includes/ajax_afiliados.php", 
               data: $("form[name=FormEditarAfiliados]").serialize(),
               success: function(result){
                  if(result.rps){
                     swal("Actualización Exitosa!", result.mensaje, "success")
                  }else{
                     swal("Disculpe!", result.mensaje, "warning")
                  }
