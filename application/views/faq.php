            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 text-left" style="padding-bottom: 10px !important;">
                        <p style="color: #1db8ea;"><strong><?php echo replace_vocales_voculeshtml("¿BITSHARE es una empresa de Multinivel?");?></strong></p>  
                    ...
                    <div class="col-md-12 text-left" style="padding-bottom: 10px !important;">
                        <p style="color: #1db8ea;"><strong><?php echo replace_vocales_voculeshtml("¿BITSHARE es una empresa legal?");?></strong></p>  
                    ...
                    <div class="col-md-12 text-left" style="padding-bottom: 10px !important;">
                        <p style="color: #1db8ea;"><strong><?php echo replace_vocales_voculeshtml("¿Por qué BITSHARE no es una pirámide financiera o un esquema ponzi?");?></strong></p>  
                         ...
                         <p><?php echo replace_vocales_voculeshtml("4) Todas las personas tienen las mismas oportunidades de ganancia y no tan solo los primeros.");?></p>
                         <p><?php echo replace_vocales_voculeshtml("5) Para cobrar las comisiones no es necesario traer a nuevos socios a la compañía.");?></p><br>
                    </div>
                    <div class="col-md-12 text-left" style="padding-bottom: 10px !important;">
                        <p style="color: #1db8ea;"><strong><?php echo replace_vocales_voculeshtml("¿Cuánto es la comisión por sacar nuestro dinero a otros monederos externos de bitcoin?");?></strong></p>  
                         <p><?php echo replace_vocales_voculeshtml("- El 7% del monto enviado por gastos administrativos y operacionales.");?></p><br>
                    </div>                        
                    <div class="col-md-12 text-left" style="padding-bottom: 10px !important;">
                        <p style="color: #1db8ea;"><strong><?php echo replace_vocales_voculeshtml("¿Cuánto es lo mínimo para cobrar en BITSHARE?");?></strong></p>  
                         <p><?php echo replace_vocales_voculeshtml("- Desde 15 dólares un asociado ya puede solicitar la petición de cobro.");?></p><br>
                    </div>  
                    <div class="col-md-12 text-left" style="padding-bottom: 10px !important;">
                        <p style="color: #1db8ea;"><strong><?php echo replace_vocales_voculeshtml("¿Cuantas cuentas puedo tener en la empresa?");?></strong></p>  
                         <p><?php echo replace_vocales_voculeshtml("- El máximo de cuentas permitido por persona son de 10 cuentas y cada cuenta es independiente y autónoma.");?></p><br>
                    </div> 
                    <div class="col-md-12 text-left" style="padding-bottom: 10px !important;">
                        <p style="color: #1db8ea;"><strong><?php echo replace_vocales_voculeshtml("¿Tengo que esperar los 120 días para sacar mi dinero y en cuanto tiempo retorna mi capital  ?");?></strong></p>  
                        <p><?php echo replace_vocales_voculeshtml("- No, en BITSHARE los distribuidores pueden cobrar de forma diaria de lunes a domingo, lo mínimo que la empresa pide para cobrar es tener $15 de ganancia como mínimo. Si un distribuidor solo genera por usufructo, el retorno de capital en promedio se recupera la compra en 3 meses.");?></p><br>
                    </div>
                    <div class="col-md-12 text-left" style="padding-bottom: 10px !important;">
                        <p style="color: #1db8ea;"><strong><?php echo replace_vocales_voculeshtml("¿Tengo algún límite de personas para invitar a BITSHARE?");?></strong></p>  
                         <p><?php echo replace_vocales_voculeshtml("- No, un distribuidor puede invitar a tantas personas como quiera lo único que se pide es que cumplan con reglas de ética de la empresa.");?></p><br>
                    </div> 
                    <div class="col-md-12 text-left" style="padding-bottom: 10px !important;">
                        <p style="color: #1db8ea;"><strong><?php echo replace_vocales_voculeshtml("¿Qué es el usufructo?");?></strong></p>  
                    ...
                    <div class="col-md-12 text-left" style="padding-bottom: 10px !important;">
                        <p style="color: #1db8ea;"><strong><?php echo replace_vocales_voculeshtml("¿BITSHARE tiene alguna pasarela de bitcoin?");?></strong></p>  
                         <p><?php echo replace_vocales_voculeshtml("- No, en los próximos meses se está lanzando la primera pasarela de bitcoin de la empresa llamada BITSHARE WALLET, de esa forma se podrá comercializar los bitcoin directamente de bitshare como negocio hacia la pasarela bitshare.");?></p><br>
                    </div>
                    <div class="col-md-12 text-left" style="padding-bottom: 10px !important;">
                        <p style="color: #1db8ea;"><strong><?php echo replace_vocales_voculeshtml("¿En qué momento se puede hacer el upgrade?");?></strong></p>  
                    ...
                    <div class="col-md-12 text-left" style="padding-bottom: 10px !important;">
                     ...
                     <div class="col-md-12 text-left" style="padding-bottom: 10px !important;">
                        <p style="color: #1db8ea;"><strong><?php echo replace_vocales_voculeshtml("¿Cuánto es lo máximo que puedo ganar por cuenta?");?></strong></p>  
